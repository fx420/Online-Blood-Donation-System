...
<html lang="en">
    <head>
        ...
        <title>Gallery - FusionTech</title>
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <a class="nav-link active" href="gallery_index.php">
    ...
    <script type="text/javascript">
      ...
      confirmButtonText: 'Yes, delete: IMG' + id
    }).then((result) => {
      if (result.isConfirmed) {
        $.ajax({
        ...
        <div class="modal-content">
          ...
          <div class="modal-body ">
            <div class="input-group mb-3">
              ...
              <input type="file" name="inputImage" class="form-control" id="inputImage" accept="image/*">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary">Save as New Image</button>
          </div>
        </div>
        </form>
      </div>
