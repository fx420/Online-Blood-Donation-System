...
<html lang="en">
    <head>
      ...
      <title>Location List - FusionTech</title>
                        ...
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <div class="collapse show" id="collapseInv" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesMenu">
                                    ...
                                    <a class="nav-link active" href="location_index.php">Blood Location</a>
                                </nav>
                            </div>
                            ...
                            <div class="page-header-content">
                                <div class="row align-items-center justify-content-between pt-3">
                                    ...
                                    <div class="col-12 col-xl-auto mb-3">
                                        ...
                                        <a class="btn btn-sm btn-light text-primary" href="location_pdf.php">
    ...
    $(document).on('click', '.deleteBtn', function(event) {
      ...
      Swal.fire({
      title: 'Are you sure?',
      text: "Delete Blood Location: BBG" + id ,
      icon: 'warning',
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <select name="inputBloodbag" id="inputBloodbag" class="inputBloodbag selectpicker form-control" data-live-search="true" title="Choose one of the following..." required>
                  <?php
                  while($row = mysqli_fetch_assoc($totalQuery))
                  { 
                    echo "<option value='".$row["bloodbag_id"]."' id='inputBloodbag' name='inputBloodbag'>"."BBG".$row["bloodbag_id"]." - ".$row["donor_username"]."</option>";
                  }
                  ?>
                </select>
              </div>
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <select name="inputInventory" id="inputInventory" class="inputInventory selectpicker form-control" data-live-search="true" title="Choose one of the following..." required>
                  <?php
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary">Add Blood Location</button>
          </div>
        </div>
        </form>
      </div>
    ...
    <div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true" data-bs-keyboard="false">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Modify Selected Blood Location</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          ...
          <div class="modal-body">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
              <select name="_inputInventory" id="_inputInventory" class="_inputInventory selectpicker form-control" data-live-search="true" title="Choose one of the following..." required>
                  <?php
