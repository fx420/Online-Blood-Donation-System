...
if(empty($_FILES['image'])){
    ...
    `healthcarep_contact`='$healthcarep_contact', `center_id`= '$center_id' WHERE healthcarep_id='$id' ";
        ...
        if($move){
        		...
        		$img_path .= $filename;
				$sql = "UPDATE `healthcare_professional` SET  `healthcarep_username`='$healthcarep_username' ,`healthcarep_password`='$healthcarep_password' ,`healthcarep_name`='$healthcarep_name' , `healthcarep_email`= '$healthcarep_email',
             `healthcarep_contact`='$healthcarep_contact', `center_id`= '$center_id', `image`='$img_path' WHERE healthcarep_id='$id' ";
				$query= mysqli_query($conn,$sql);
