...
<html lang="en">
    <head>
        ...
        <title>Contact Form List - FusionTech</title>
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <a class="nav-link active" href="contact_index.php">
                        ...
                        <div class="container-fluid px-4">
                            <div class="page-header-content">
                                <div class="row align-items-center justify-content-between pt-3">
                                    ...
                                    <a class="btn btn-sm btn-light text-primary" href="contact_pdf.php">
    ...
    $(document).on('click', '.deleteBtn', function(event) {
      ...
      Swal.fire({
      title: 'Are you sure?',
      text: "Delete Contact Form: CFM" + id ,
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
      confirmButtonText: 'Yes, delete: CFM' + id
    }).then((result) => {
