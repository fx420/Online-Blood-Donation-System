...
<html lang="en">
    <head>
      ...
      <title>Inventory List - FusionTech</title>
                    ...
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <div class="collapse show" id="collapseInv" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesMenu">
                                    <a class="nav-link active" href="inventory_index.php">Manage Inventory</a>
            ...
            <div class="page-header-content">
              <div class="row align-items-center justify-content-between pt-3">
                ...
                <div class="col-12 col-xl-auto mb-3">
                  ...
                  <a class="btn btn-sm btn-light text-primary" href="inventory_pdf.php
                  ">
      ...
      <div class="modal-content">
        ...
        <form id="updateUserForm" action="javascript:void();" method="post" class="was-validated">
          <div class="modal-body">
            ...
            <div class="mb-3 row">
              <label for="_inputCenter" class="col-sm-3 col-form-label">Center ID: </label>
              <div class="col-sm-9">
  ...
  <div class="modal fade" id="viewBloodQuantity" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
