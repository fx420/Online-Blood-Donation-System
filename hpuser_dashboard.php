...
<html lang="en">
    <head>
        ...
        <title>Dashboard - FusionTech</title>
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <a class="nav-link active" href="hpuser_dashboard.php">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-xl px-4 mt-5">
                        ...
                        <div class="card card-waves mb-4 mt-5">
                            <div class="card-body p-5">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col">
                                        <h1 class="text-primary">Welcome back to Fusion Tech Blood Donation Center Hi Healthcare Professional</h1>
                        ...
                        <center><h1>Currently Blood Collection <?php echo $total_volume[0] ?> liters</h1></center>
                        <?php $width = ($total_volume[0] /650) * 100 ?>
                        ...
                        <center>
                        <span>(Daily collection target 650 )</span>
                        <br>
                        <span>(Total collection yesterday: <?php echo $total_volume2[0]?>)</span>
                        <br>
                        <span>Data update date: <?php echo $current_date ?></span>
                        <br>
                        </center>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">Total Blood Donation Record 2022 (Montly)</div>
                            <div class="card-body">
                                <div class="card-body">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">Total Blood Request Record 2022 (Montly)</div>
                            <div class="card-body">
                                <div class="card-body">
