...
if(isset($_POST['submit']))
{
   ...
   if(empty($contact_form_email) || empty($seeker_username) || empty($contact_form_subject) || empty($contact_form_message))
   {
     echo "<script>alert('Woops! Something Wrong Went.')</script>";
   } 
   else
   {
    $insert = mysqli_query($conn, "INSERT INTO `contact_form`(seeker_username,contact_form_email, contact_form_subject, contact_form_message) VALUES('$seeker_username','$contact_form_email', '$contact_form_subject', '$contact_form_message')") or die('query failed');
    if($insert){
...
<div class="containers">
  <div class="content">
    ...
    <?php
      ...
      ?>
      <div class="input-box">
        <input type="hidden" name="seeker_username" placeholder="Username" value="<?php echo $fetch['seeker_username']; ?>" required="required" >
      </div>
      <div class="input-box">
        <input type="email" name="contact_form_email" placeholder="Email" value="<?php echo $fetch['seeker_email']; ?>" required="required" >
      </div>
      <div class="input-box">
