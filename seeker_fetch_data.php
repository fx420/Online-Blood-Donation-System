...
while($row = mysqli_fetch_assoc($query))
{
	...
	$sub_array[] = '<a href="javascript:void();" data-id="'.$row['seeker_id'].'" class="btn btn-info btn-sm editbtn" ><i class="fa-solid fa-pen-to-square"></i></a>  <a href="javascript:void();" data-id="'.$row['seeker_id'].'"  class="btn btn-danger btn-sm deleteBtn" ><i class="fa-solid fa-trash"></i></a>';
	$data[] = $sub_array;
}
