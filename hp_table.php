...
<html lang="en">
      <head>
        ...
        <title>Healthcare Professional - FusionTech</title>
                        ...
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <div class="collapse show" id="collapseProfile" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesMenu">
                                    ...
                                    <a class="nav-link active" href="hp_table.php">Healthcare Professional</a>
                            ...
                            <div class="page-header-content">
                                <div class="row align-items-center justify-content-between pt-3">
                                    ...
                                    <div class="col-12 col-xl-auto mb-3">
                                        ...
                                        <a class="btn btn-sm btn-light text-primary" href="hp_pdf.php">
        ...
        buttons: [
          {
            ...
            autoFilter: true,
            className: '',
            messageTop: 'Healthcare Professional Profiles',
    ...
    <script type="text/javascript">
       $(document).on('submit', '#saveUserForm', function(event) {
        ...
        var healthcarep_username = $('#inputUsername').val();
        var healthcarep_password = $('#inputPassword').val();
        var healthcarep_name = $('#inputName').val();
        var healthcarep_email = $('#inputEmail').val();
        var healthcarep_contact = $('#inputContact').val();
        var center_id = $('#inputCenterID').val();
        var image = $('#inputImage')[0].files[0];


        if (healthcarep_username != '' && healthcarep_password != '' && healthcarep_name != '' && healthcarep_email != '' && healthcarep_contact != '' && center_id != '') {
    ...
    $(document).on('click', '.editbtn',function(event){
      ...
      $.ajax({
        url:"hp_get_single.php",
        data:{id:id},
        type:"post",
        success:function(data)
        {
          var json = JSON.parse(data);
          $('#id').val(json.healthcarep_id);
          $('#idforshown').val(json.prefix+ json.healthcarep_id);
          $('#trid').val(trid);
          $('#_inputUsername').val(json.healthcarep_username);
          $('#_inputPassword').val(json.healthcarep_password);
          $('#_inputName').val(json.healthcarep_name);
          $('#_inputEmail').val(json.healthcarep_email);
          $('#_inputContact').val(json.healthcarep_contact);
          $('._inputCenterID').selectpicker('val', [json.center_id]);
    ...
    $(document).on('submit', '#updateUserForm',function(){
      ...
      var center_id = $('#_inputCenterID').val();
    ...
    $(document).on('click', '.deleteBtn', function(event) {
      ...
      Swal.fire({
      title: 'Are you sure?',
      text: "Delete Profile: HCP" + id ,
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
      confirmButtonText: 'Yes, delete: HCP' + id
    }).then((result) => {
      if (result.isConfirmed) {
        $.ajax({
          url: "hp_delete.php",
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add New Healthcare Professional</h5>
          ...
          <div class="modal-body">
            ...
            <div class="mb-3 row">
              <label for="inputCenterID" class="col-sm-3 col-form-label">Center ID: </label>
              <div class="col-sm-9">
                <select name="inputCenterID" id="inputCenterID" class="inputCenterID selectpicker form-control" data-live-search="true" title="Choose one of the following..." required>                
                  <?php
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary">Add Healthcare Professional</button>
          </div>
        </div>
        </form>
      </div>
    </div>
    <!-- end add healthcarep modal -->

    <!-- update healthcarep modal -->
    <!-- Modal -->
    <div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true" data-bs-keyboard="false">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Modify Selected Healthcare Professional</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          ...
          <div class="modal-body">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-9">
              <input type="text" name="_username" class="form-control" id="_inputUsername" pattern="^(?=.{5,50}$)(?![_.])(?!.*[_.]{2})[a-zA-Z0-9._]+(?<![_.])$" disabled>
              </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
              <label for="_inputCenterID" class="col-sm-3 col-form-label">Center ID: </label>
              <div class="col-sm-9">
                <select name="_inputCenterID" id="_inputCenterID" class="_inputCenterID selectpicker form-control" data-live-search="true" title="Choose one of the following..." required>                
                  <?php
