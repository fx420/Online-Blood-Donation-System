...
<section class="development" style="  background-color: #fff;">
        ...
        <div class="row-development">
            <div class="col-development development development-box">
                ...
                and continues to recruit voluntary blood seekers to ensure that Malaysia's blood supply remains self-sufficient. With the development of clinical medical technology and the increasing demand for hematopoietic stem cells from patients, Fusion Tech will establish a public cord blood bank in 2022. Fusion Tech continues to recruit volunteer seekers and find patients suitable unrelated bone marrow for transplantation.
                <br><br>
                In addition, Fusion Tech places great emphasis on the pursuit of excellent service and continuous improvement of quality, and is committed to ensuring the safety and efficacy of blood seekers and recipients. To this end, the center has established a set of quality management system, which comprehensively covers the whole process from blood donation to blood transfusion.
                Fusion Tech will continue to improve the overall blood seeker satisfaction by improving the blood donation center environment and service level, enhance the community's awareness of the importance of blood donation, and encourage citizens to donate blood regularly to stabilize the blood supply in Hong Kong.
                </div>
            </div>
        </div>
</section>
