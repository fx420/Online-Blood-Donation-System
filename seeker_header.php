...
<header class="header">
    ...
    <nav class="navbar">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
              <a href="eeker_blood_request.php" >Blood Request</a>
    ...
    <?php $sql = "SELECT * FROM blood_request where seeker_username='$seeker_username' and request_status = 'pending' and status='0' ORDER BY request_date_time  DESC";
    ...
    <?php
      ...
      ?>
          <center > 
           <?php
            if($fetch['image'] == ''){
               echo ' <a href="seeker_update_profile.php"><img src="assets/img/images/default-avatar.png" >' ;
            }else{
               echo ' <a href="seeker_update_profile.php"><img src="assets/img/upload/seeker/'.$fetch['image'].'">';
            }
           ?>
            </center>
...
<nav>
		...
		<div class="notifi-box" id="box" style="    z-index: 1;">
            ...
            <?php
                $query = "SELECT * FROM blood_request where seeker_username='$seeker_username' and request_status = 'pending'  ORDER BY request_date_time DESC";
                ...
                ?>
                         ...
                         ?> 
                         " class="dropdown-item" href="notiview.php?id=<?php echo $i['request_id'] ?> " >
			<div class="notifi-item" >
                
            <div class="text" id="notifications"  >  

            <h4 style="font-weight:900;"> Appointment Reminder !!!</h4> <br>
                 <p style="  font-size: 17px;"> <?php echo date('F j, Y, g:i a',strtotime($i['request_date_time'])) ?></p>
                 <p style="  font-size: 17px;"> Appointment ID : <?php echo $i ["request_id"];?> </p>
                 <p style="  font-size: 17px;"> Status : <?php echo $i ["request_status"];?> </p>
