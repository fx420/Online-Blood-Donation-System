...
<html lang="en">
    <head>
      ...
      <title>FAQ List - FusionTech</title>
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <a class="nav-link active" href="faq_table.php">
                            ...
                            <div class="page-header-content">
                                <div class="row align-items-center justify-content-between pt-3">
                                    ...
                                    <div class="col-12 col-xl-auto mb-3">
                                        ...
                                        <a class="btn btn-sm btn-light text-primary" href="faq_pdf.php">
    ...
    <script type="text/javascript">
       $(document).on('submit', '#saveUserForm', function(event) {
        ...
        var faq_title = $('#inputTitle').val();
        var faq_answer = $('#inputAnswer').val();

        if (faq_title != '' && faq_answer != '') {
          var form = new FormData();
          form.append("faq_title", faq_title);
          form.append("faq_answer", faq_answer);
    ...
    $(document).on('click', '.editbtn',function(event){
      ...
      $.ajax({
        ...
        success:function(data)
        {
          ...
          $('#id').val(json.faq_id);
          $('#idforshown').val(json.prefix + json.faq_id);
          $('#trid').val(trid);
          $('#_inputTitle').val(json.faq_title);
          $('#_inputAnswer').val(json.faq_answer);
    ...
    $(document).on('submit', '#updateUserForm',function(){
      var id = $('#id').val();
      var trid = $('#trid').val();
      var faq_title = $('#_inputTitle').val();
      var faq_answer = $('#_inputAnswer').val();
      var form = new FormData();
        form.append("id", id);
        form.append("faq_title", faq_title);
        form.append("faq_answer", faq_answer);
    ...
    $(document).on('click', '.deleteBtn', function(event) {
      ...
      Swal.fire({
      title: 'Are you sure?',
      text: "Delete FAQ: FAQ" + id ,
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
      confirmButtonText: 'Yes, delete: FAQ' + id
    }).then((result) => {
      if (result.isConfirmed) {
        $.ajax({
          url: "faq_delete.php",
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-3 row">
              ...
              <div class="col-sm-9">
              <input type="text" name="inputTitle" class="form-control" id="inputTitle" required>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="inputAnswer" class="col-sm-3 col-form-label">Answer: </label>
              <div class="col-sm-9">
              <input type="text" name="inputAnswer" class="form-control" id="inputAnswer" required>
              </div>
            </div>
          </div>
    ...
    <div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true" data-bs-keyboard="false">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Modify Selected FAQ</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          ...
          <div class="modal-body">
            ...
            <div class="mb-3 row">
              <label for="idforshown" class="col-sm-3 col-form-label">FAQ ID: </label>
              <div class="col-sm-9">
                <input type="text" name="idforshown" class="form-control" id="idforshown" disabled>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="_inputTitle" class="col-sm-3 col-form-label">Title: </label>
              <div class="col-sm-9">
              <input type="text" name="_inputTitle" class="form-control" id="_inputTitle" required>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="_inputAnswer" class="col-sm-3 col-form-label">Answer: </label>
              <div class="col-sm-9">
              <input type="text" name="_inputAnswer" class="form-control" id="_inputAnswer" required>
              </div>
            </div>
          </div>
          <div class="modal-footer">
